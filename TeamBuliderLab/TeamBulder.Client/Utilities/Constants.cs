...
namespace TeamBulder.Client.Utilities
{
	public static class Constants
	{
		...
		public const int MinEventName = 0;
		public const int MaxEventName = 25;

		public const int MinDescription = 0;
		public const int MaxDescription = 250;

		public const int MinTeamName = 0;
		public const int MaxTeamName = 25;
		...
		public static class ErrorMessages
		{
			...
			public const string InvalidStarDate = "Start date can`t be after the end date. Please insert new date";
