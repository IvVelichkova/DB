namespace BookShopSystem.Client
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            //var book1 = new Book();
            //book1.Title= "A che punto Ã la note After Many a Summer Dies the Swan Ah";
            //book1.AgeRestriction = 2;



            BookShopContext context = new BookShopContext();

            context.Authors.Add(new Author { FirstName = "George", LastName = "Powell" });
                context.SaveChanges();
            context.Books.Add(new Book { Title = "A che punto Ã la note After Many a Summer Dies the Swan Ah", AgeRestriction = AgeRestriction.Minor, Description = "book1", EditionType = EditionType.Gold, Price = 22.10m, Copies = 5, ReleaseDate = new DateTime(2016, 01, 01) });
            context.SaveChanges();

            context.Categories.Add(new Category { Name = "Roman" });
            context.SaveChanges();
